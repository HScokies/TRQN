    ...
    return (
        <div className='profile-page'>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <Input type='text' name='fullName' label='* Full Name' defaultValue={Mock.fullName} />
                <Input type='text' name='street' label='* Street Address' defaultValue={Mock.street} />
                <Input type='text' name='apartment' label='Apartment, Suite, Unit, Building, Floor, etc.' pattern='[a-zA-Z0-9, ]+' defaultValue={Mock.apartment} />
                <Input type='text' name='city' label='* City' defaultValue={Mock.city} />
                <Input type='text' name='zip' label='* Zip / Postal code' pattern='[0-9]{5,6}' defaultValue={Mock.zip} />
